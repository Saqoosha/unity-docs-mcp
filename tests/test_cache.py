...
class TestAPICaching(unittest.TestCase):
    ...
    def test_cache_save_and_load(self):
        ...
        test_data = {
            "GameObject": {"available": ["6000.0", "2022.3"], "unavailable": ["2019.4"]},
            "AsyncGPUReadback": {"available": ["6000.0"], "unavailable": ["2019.4", "2020.3"]}
        }
...
class TestSearchIndexCaching(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.temp_dir = tempfile.mkdtemp()
        self.search_index = UnitySearchIndex(cache_dir=self.temp_dir, cache_duration_hours=24)
    ...
    def test_save_and_load_cache(self):
        ...
        # Create test data
        self.search_index.pages = [["GameObject", "GameObject"], ["Transform", "Transform"]]
    ...
    def test_memory_cache_functionality(self):
        ...
        self.search_index._memory_cache[cache_key] = (
            test_pages, test_info, test_search, test_common
        )
        
        # Load should use memory cache
        with patch.object(self.search_index, '_load_from_cache', return_value=False) as mock_load:
    ...
    def test_clear_cache_all_versions(self):
        ...
        cache_files = [f for f in os.listdir(self.temp_dir) if f.startswith("search_index_")]
