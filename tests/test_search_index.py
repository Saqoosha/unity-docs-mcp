...
class TestUnitySearchIndex(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_info = [
            ...
            ["Activates/Deactivates the GameObject, depending on the given true or false value.", 1],
...
"""
    ...
    def test_search_basic(self, mock_load_index):
        ...
        self.search_index._memory_cache['index_6000.0'] = (
            self.sample_pages, self.sample_info, self.sample_search_index, set(self.sample_common.keys())
        )
    ...
    def test_combined_search_term(self, mock_load_index):
        ...
        # Also add to memory cache
        self.search_index._memory_cache['index_6000.0'] = (
            self.sample_pages, self.sample_info, self.search_index.search_index, set()
        )
